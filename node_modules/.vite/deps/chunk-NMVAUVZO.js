...
var Engine = class _Engine extends ThinEngine {
   ...
   */
  setDepthStencilTexture(channel, uniform, texture, name5) {
    if (channel === void 0) {
      return;
    }
    if (uniform) {
    ...
    if (!texture || !texture.depthStencilTexture) {
      this._setTexture(channel, null, void 0, void 0, name5);
    } else {
   ...
   */
  setTextureFromPostProcess(channel, postProcess, name5) {
    ...
    this._bindTexture(channel, (postProcessInput == null ? void 0 : postProcessInput.texture) ?? null, name5);
  }
  /**
   ...
   * @param name name of the channel
   */
  setTextureFromPostProcessOutput(channel, postProcess, name5) {
    var _a;
    this._bindTexture(channel, ((_a = postProcess == null ? void 0 : postProcess._outputTexture) == null ? void 0 : _a.texture) ?? null, name5);
  }
  /**
...
var FileFaceOrientation = class {
  constructor(name5, worldAxisForNormal, worldAxisForFileX, worldAxisForFileY) {
    this.name = name5;
...
var Texture = class _Texture extends BaseTexture {
   ...
   * @internal
   */
  static _CreateVideoTexture(name5, src, scene, generateMipMaps = false, invertY = false, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, settings = {}, onError, format = 5) {
   ...
   */
  static CreateFromBase64String(data, name5, scene, noMipmapOrOptions, invertY, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags) {
    return new _Texture("data:" + name5, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, data, false, format, void 0, void 0, creationFlags);
  }
  /**
   ...
   * @returns the created texture
   */
  static LoadFromDataString(name5, buffer, scene, deleteBuffer = false, noMipmapOrOptions, invertY = true, samplingMode = _Texture.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags) {
    if (name5.substr(0, 5) !== "data:") {
      name5 = "data:" + name5;
    }
    return new _Texture(name5, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, void 0, void 0, creationFlags);
  }
};
...
Texture._CreateMirror = (name5, renderTargetSize, scene, generateMipMaps) => {
...
var PostProcess = class _PostProcess {
  ...
  /** @internal */
  constructor(name5, fragmentUrl, parameters, samplers, _size, camera, samplingMode = 1, engine, reusable, defines = null, textureType = 0, vertexUrl = "postprocess", indexParameters, blockCompilation = false, textureFormat = 5, shaderLanguage = ShaderLanguage.GLSL) {
    this._parentContainer = null;
    this.width = -1;
    this.height = -1;
...
var PassPostProcess = class _PassPostProcess extends PostProcess {
   ...
   */
  constructor(name5, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    super(name5, "pass", null, null, options, camera, samplingMode, engine, reusable, void 0, textureType, void 0, null, blockCompilation);
  }
  /**
   * @internal
   */
...
var PassCubePostProcess = class _PassCubePostProcess extends PostProcess {
   ...
   */
  constructor(name5, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    super(name5, "passCube", null, null, options, camera, samplingMode, engine, reusable, "#define POSITIVEX", textureType, void 0, null, blockCompilation);
    this._face = 0;
  }
  /**
   * @internal
...
//# sourceMappingURL=chunk-NMVAUVZO.js.map
