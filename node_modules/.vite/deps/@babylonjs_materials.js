import {
  ShadowOnlyMaterial
} from "./chunk-ODEKFHW2.js";
import {
  CreateGround,
  DynamicTexture,
  ShaderCodeInliner
} from "./chunk-SB5LGKWF.js";
import "./chunk-4F3LVHSX.js";
import {
  Constants,
  MaterialFlags,
  PBRMaterial,
...
var CellMaterial = class _CellMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _CellMaterial(name28, this.getScene()), this);
  }
  serialize() {
...
var CustomMaterial = class _CustomMaterial extends StandardMaterial {
   ...
   * @internal
   */
  ReviewUniform(name28, arr) {
    if (name28 == "uniform" && this._newUniforms) {
    ...
    if (name28 == "sampler" && this._newUniforms) {
      for (let ind = 0; ind < this._newUniforms.length; ind++) {
        if (this._customUniform[ind].indexOf("sampler") != -1) {
          arr.push(this._newUniforms[ind].replace(/\[\d*\]/g, ""));
        }
  ...
  Builder(shaderName, uniforms, uniformBuffers, samplers, defines, attributes) {
    ...
    const name28 = this._createdShaderName;
    if (Effect.ShadersStore[name28 + "VertexShader"] && Effect.ShadersStore[name28 + "PixelShader"]) {
      return name28;
    }
    Effect.ShadersStore[name28 + "VertexShader"] = this._injectCustomCode(this.VertexShader, "vertex");
    Effect.ShadersStore[name28 + "PixelShader"] = this._injectCustomCode(this.FragmentShader, "fragment");
    return name28;
  }
  ...
  AddUniform(name28, kind, param) {
    ...
    if (param) {
      if (kind.indexOf("sampler") != -1) {
        this._newSamplerInstances[kind + "-" + name28] = param;
      } else {
        this._newUniformInstances[kind + "-" + name28] = param;
      }
    }
    this._customUniform.push("uniform " + kind + " " + name28 + ";");
    this._newUniforms.push(name28);
    return this;
  }
  /**
  ...
  AddAttribute(name28) {
    ...
    this._customAttributes.push(name28);
    return this;
  }
  /**
...
var FireMaterial = class _FireMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _FireMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var FurMaterial = class _FurMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _FurMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
  ...
  static GenerateTexture(name28, scene) {
    const texture = new DynamicTexture("FurTexture " + name28, 256, scene, true);
...
var GradientMaterial = class _GradientMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _GradientMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var GridMaterial = class _GridMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _GridMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var LavaMaterial = class _LavaMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _LavaMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var MixMaterial = class _MixMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _MixMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var NormalMaterial = class _NormalMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _NormalMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var name18 = "simplePixelShader";
var shader17 = `precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;varying vec3 vPositionW;
#ifdef NORMAL
varying vec3 vNormalW;
#endif
...
var SimpleMaterial = class _SimpleMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _SimpleMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var name20 = "skyPixelShader";
var shader19 = `precision highp float;varying vec3 vPositionW;
#ifdef VERTEXCOLOR
varying vec4 vColor;
#endif
#include<clipPlaneFragmentDeclaration>
...
var SkyMaterial = class _SkyMaterial extends PushMaterial {
   ...
   */
  clone(name28) {
    return SerializationHelper.Clone(() => new _SkyMaterial(name28, this.getScene()), this);
  }
  /**
...
var name22 = "terrainPixelShader";
var shader21 = `precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;
#ifdef SPECULARTERM
uniform vec4 vSpecularColor;
#endif
varying vec3 vPositionW;
...
var name23 = "terrainVertexShader";
...
var TerrainMaterial = class _TerrainMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _TerrainMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var name24 = "triplanarPixelShader";
...
var name25 = "triplanarVertexShader";
...
var TriPlanarMaterial = class _TriPlanarMaterial extends PushMaterial {
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _TriPlanarMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var WaterMaterial = class _WaterMaterial extends PushMaterial {
   ...
   */
  constructor(name28, scene, renderTargetSize = new Vector2(512, 512)) {
    super(name28, scene);
  ...
  clone(name28) {
    return SerializationHelper.Clone(() => new _WaterMaterial(name28, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
  ...
  static CreateDefaultMesh(name28, scene) {
    const mesh = CreateGround(name28, { width: 512, height: 512, subdivisions: 32, updatable: false }, scene);
    return mesh;
  }
};
__decorate([
