...
var Material = class _Material {
   ...
   */
  constructor(name24, scene, doNotAdd) {
    ...
    this._uniformBuffer = new UniformBuffer(this._scene.getEngine(), void 0, void 0, name24);
...
var PushMaterial = class extends Material {
  constructor(name24, scene, storeEffectOnSubMeshes = true) {
    super(name24, scene);
...
var MaterialDefines = class {
  ...
  rebuild() {
    ...
    if (this._externalProperties) {
      for (const name24 in this._externalProperties) {
        if (this._keys.indexOf(name24) === -1) {
          this._keys.push(name24);
        }
      }
    }
  }
...
var name3 = "lightsFragmentFunctions";
var shader3 = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
var name5 = "clipPlaneFragmentDeclaration";
var shader5 = `#ifdef CLIPPLANE
...
var name7 = "fogFragmentDeclaration";
var shader7 = `#ifdef FOG
...
var name8 = "clipPlaneFragment";
var shader8 = `#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
var name10 = "logDepthFragment";
var shader10 = `#ifdef LOGARITHMICDEPTH
...
var name11 = "fogFragment";
var shader11 = `#ifdef FOG
...
var name12 = "bonesDeclaration";
var shader12 = `#if NUM_BONE_INFLUENCERS>0
...
var name13 = "bakedVertexAnimationDeclaration";
...
var name14 = "instancesDeclaration";
var shader14 = `#ifdef INSTANCES
...
var name16 = "fogVertexDeclaration";
var shader16 = `#ifdef FOG
...
var name18 = "bonesVertex";
var shader18 = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
var name19 = "bakedVertexAnimation";
var shader19 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
var name20 = "clipPlaneVertex";
var shader20 = `#ifdef CLIPPLANE
...
var name21 = "fogVertex";
var shader21 = `#ifdef FOG
...
var name22 = "shadowsVertex";
var shader22 = `#ifdef SHADOWS
...
//# sourceMappingURL=chunk-RJZTE6P6.js.map
