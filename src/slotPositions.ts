...
export const BAG_SLOT_TRANSFORMS_LEFT: SlotTransform[] = [
  { position: new BABYLON.Vector3(0.65, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(0.65, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-0.05, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-0.05, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-0.75, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-0.75, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-1.45, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-1.45, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-2.15, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-2.15, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-2.85, 0.27, 0.7554), rotation: DEFAULT_ROTATION },
  { position: new BABYLON.Vector3(-2.85, -0.35, 0.7554), rotation: DEFAULT_ROTATION },
];
